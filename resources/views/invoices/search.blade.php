...
{!! Form::open(['route' => 'invoices.search']) !!}
...
<div class="row justify-content-center mt-3 mb-5">
    <div class="col-sm-2">
        {!! link_to_route('invoices.specifiedterm', '前月', ['id' => 'lastmonth'], ['class' => 'btn btn-block btn-outline-info btn-sm ']) !!}
    </div>
    <div class="col-sm-2">
        {!! link_to_route('invoices.specifiedterm', '今月', ['id' => 'thismonth'], ['class' => 'btn btn-block btn-outline-info btn-sm']) !!}
    </div>
    <div class="col-sm-2">
        {!! link_to_route('invoices.specifiedterm', '来月', ['id' => 'nextmonth'], ['class' => 'btn btn-block btn-outline-info btn-sm']) !!}
    </div>
</div>